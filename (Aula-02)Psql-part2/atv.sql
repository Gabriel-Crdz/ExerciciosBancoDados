...
/* Inserindo cadastro de alunos, autores, livros */

INSERT INTO alunos(nome_completo, email, codigo_matricula) 
VALUES
...
INSERT INTO autores (nome_completo, pais_origem) 
VALUES
...
/* COMANDO MERAMENTE ILUSTRATIVO(sera visto melhor futaramente) */
...
DELETE FROM livros -- Um ponto e virgula aqui deletaria todas as relaç
WHERE id_livro = 2;
